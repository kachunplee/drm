...
"var activetext = \"\";\n"
"function enaAddToFilter(e) {\n"
"\n"
"    activetext = (document.all) ? document.selection.createRange().text "
": document.getSelection();\n"
"\n"
"    if (activetext != '')\n"
"    {\n"
"        var obj = document.getElementById('seladdfilter');\n"
"        if (obj)
...
"}\n"
"\n"
"document.onmouseup = enaAddToFilter;\n"
"document.onmousedown = disAddToFilter;\n"
	...
	const char * pSubj)
{
	...
	stm << "<div id=seladdfilter align=right style=\"width=100; "
	    << "margin=10px; padding=5px; visibility=visible;\">"
            << "<a onclick=\"return javascript::AddToFilter();\">"
	    << "Add To Filter</a>"
	    << "</div>\n"
	;
